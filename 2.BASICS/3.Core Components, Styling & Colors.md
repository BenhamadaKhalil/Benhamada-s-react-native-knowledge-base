...
You also might want to explore the **official article about "Colors"** to learn about different ways of setting & using colors in React Native apps: [https://reactnative.dev/docs/colors](https://reactnative.dev/docs/colors) _(in this course, we'll primarily use hex code colors)._
